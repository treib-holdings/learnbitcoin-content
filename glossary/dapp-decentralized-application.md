...
slug: dapp-decentralized-application
draft: false
shortDefinition: "An application running on a decentralized network, typically Ethereum or other programmable chains-can also exist on Bitcoin sidechains."
keyTakeaways:
  - "Uses smart contracts for trust-minimized operations"
  - "Mostly hosted on Ethereum or other Turing-complete blockchains"
  - "May integrate with Bitcoin via sidechains or bridging"
sources: []
relatedTerms:
