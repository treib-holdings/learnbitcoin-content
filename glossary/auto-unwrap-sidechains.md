---
title: "Auto Unwrap (Sidechains)"
slug: auto-unwrap-sidechains
draft: false
shortDefinition: "A proposal where pegged BTC automatically returns to the Bitcoin main chain after a certain trigger or condition, removing manual steps."
keyTakeaways:
  - "Simplifies the re-pegging process back to mainnet"
  - "Reduces manual intervention or potential oversight"
  - "Requires robust conditions to avoid misuse"
sources: []
relatedTerms:
  - liquid-network
  - one-way-peg
