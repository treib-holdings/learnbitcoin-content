...
shortDefinition: "A 2018 hard fork of Bitcoin Cash - a fork of a fork - led by Craig Wright and Calvin Ayre under the 'Satoshi's Vision' banner. Known for very large blocks, a hash war with Bitcoin Cash, exchange delistings, and Wright's discredited claim to be Satoshi Nakamoto."
keyTakeaways:
...
sources:
  - { label: "High Court of Justice - COPA v Wright judgment (2024) EWHC 1198 (Ch)", url: "https://www.judiciary.uk/wp-content/uploads/2024/07/COPA-v-Wright-Judgment.pdf" }
  - { label: "CoinDesk - Kraken Exchange Joins Binance, ShapeShift in Delisting Bitcoin SV (2019)", url: "https://www.coindesk.com/markets/2019/04/16/kraken-exchange-joins-binance-shapeshift-in-delisting-bitcoin-sv" }
relatedTerms:
  - bitcoin-cash
  - block-size-war
  - altcoin
  ...
  - fork
sameAs:
  - "https://en.wikipedia.org/wiki/Bitcoin_SV"
liveWidget: ~
---

Bitcoin SV ("SV" stands for "Satoshi's Vision") is a hard fork of [Bitcoin Cash](/glossary/bitcoin-cash), which is itself a hard fork of Bitcoin. It split off on November 15, 2018, which puts it two forks away from the original chain.
...
BSV's defining bet is enormous blocks. Where Bitcoin keeps blocks small on purpose to keep [full nodes](/glossary/full-node) cheap to run, BSV stripped out practical limits in pursuit of gigabyte-scale blocks and cheap on-chain data storage.
