...
slug: hidden-miner
draft: false
shortDefinition: "Malware that hijacks a victim’s CPU/GPU resources to stealthily mine cryptocurrency, though Bitcoin mining is typically unprofitable this way."
keyTakeaways:
  - "Malicious software using your hardware for unauthorized mining"
  - "Ineffective on Bitcoin due to ASIC dominance"
  - "Still a concern for resource drain and security breaches"
sources: []
relatedTerms:
