...
See the [Quantum and Bitcoin rabbit hole](/rabbit-hole/quantum-and-bitcoin) for the always-exposed problem P2MR is designed to address.

Spec: [BIP-360](https://github.com/bitcoin/bips/blob/master/bip-0360.mediawiki).

See [How Taproot Actually Works](/rabbit-hole/how-taproot-works) for the Taproot construction that P2MR keeps and the key path it removes.
