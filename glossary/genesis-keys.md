...
slug: genesis-keys
draft: false
shortDefinition: "A speculative term referring to any private keys possibly held by Satoshi from the earliest blocks. Not publicly revealed."
keyTakeaways:
  - "Believed to be Satoshi’s earliest mined BTC keys"
  - "No confirmed spending from these addresses"
  - "Epitomizes the mythos and mystery surrounding Bitcoin’s creator"
sources: []
relatedTerms:
  - genesis-block
