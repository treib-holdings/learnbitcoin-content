...
slug: gyft-block
draft: false
shortDefinition: "A colloquial term referencing blocks that contained large merchant Gyft transactions, historically notable in early Bitcoin commerce."
keyTakeaways:
  - "Refers to blocks featuring sizable Gyft transactions"
  - "Symbolizes a milestone in early merchant adoption"
  - "Example of how real-world commerce can stand out on-chain"
sources: []
relatedTerms:
  - block
  - gweek
