...
That cancellation is usually marked as the end of the [block size war](/glossary/block-size-war). The big-block side had already forked off as [Bitcoin Cash](/glossary/bitcoin-cash) back in August, and the attempt to also enlarge Bitcoin itself was now dead. The episode confirmed a rule that still holds: changing Bitcoin's consensus rules requires the people running nodes to go along, and no amount of mining power or corporate backing is a substitute for that.
