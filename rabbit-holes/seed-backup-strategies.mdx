...
hasInteractive: []
ogImage: "/diagrams/og/threat-triangle.png"
ogImageAlt: "A triangle with three corners labeled THEFT, LOSS, and COERCION, each with a concrete example. At the center sits the seed phrase being defended. The three threats every Bitcoin seed backup must plan for."
---
