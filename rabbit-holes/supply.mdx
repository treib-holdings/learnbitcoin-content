...
sources:
  ...
  - { label: "ChainQuery - live supply data (/api/edu/supply)", url: "https://chainquery.com/api/edu/supply" }
...
This is what people mean when they say Bitcoin is *front-loaded* and *disinflationary*. Most of the supply is already out. The schedule [asymptotes](/glossary/asymptote) toward zero.
