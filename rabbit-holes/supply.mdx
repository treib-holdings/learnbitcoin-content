...
sources:
  ...
  - { label: "chainquery - live supply data (/api/edu/supply, in progress)", url: "https://chainquery.com" }
...
This is what people mean when they say Bitcoin is *front-loaded* and *disinflationary*. Most of the supply is already out. The schedule asymptotes toward zero.
...
> **Coming soon:** A live chart pulling current supply, annual issuance, and inflation rate from our own Bitcoin node via `chainquery.com/api/edu/supply`. The endpoint is being built in parallel.
