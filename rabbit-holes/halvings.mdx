...
sources:
  ...
  - { label: "chainquery - live halving countdown (/api/edu/halving, in progress)", url: "https://chainquery.com" }
...
> **Coming soon:** A live countdown to the next halving, pulled from our own Bitcoin node via `chainquery.com/api/edu/halving`. The endpoint is being built in parallel; when it's live, the count will appear here in real time.
