...
sources:
  ...
  - { label: "ChainQuery - live halving countdown (/api/edu/halving)", url: "https://chainquery.com/api/edu/halving" }
...
The [asymptote](/glossary/asymptote) is set: by 2140 the last fractional satoshi will be issued, after which miners earn revenue exclusively from transaction fees.
