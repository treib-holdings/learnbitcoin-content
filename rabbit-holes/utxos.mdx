...
Here is the critical part: **UTXOs are consumed whole.** You can not spend half of a UTXO. If you have a UTXO worth 0.5 BTC and you want to send someone 0.1 BTC, you spend the entire 0.5 BTC UTXO. The transaction creates two new UTXOs: one for 0.1 BTC to the recipient, one for roughly 0.39999 BTC (minus fees) back to you.
