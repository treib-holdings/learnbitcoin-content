...
sources:
  ...
  - { label: "ChainQuery - live difficulty (/api/edu/difficulty)", url: "https://chainquery.com/api/edu/difficulty" }
  - { label: "ChainQuery - live mempool (/api/edu/mempool-summary)", url: "https://chainquery.com/api/edu/mempool-summary" }
