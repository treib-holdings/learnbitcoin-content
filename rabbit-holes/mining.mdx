...
sources:
  ...
  - { label: "chainquery - live difficulty + mempool (/api/edu/* in progress)", url: "https://chainquery.com" }
...
> **Coming soon:** A live difficulty countdown and current value, pulled from our own Bitcoin node via `chainquery.com/api/edu/difficulty`.
...
> **Coming soon:** A live mempool histogram and fee market visualization powered by `chainquery.com/api/edu/mempool-summary`. Will show how the fee market is sorting transactions right now.
